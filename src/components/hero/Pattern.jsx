const Pattern = () => {
  return (
    <div className="absolute overflow-hidden w-full sm:h-[800px] h-[800px] z-0">
      <div className="absolute bg-transparent border-[1px] border-textSecondary/20 sm:w-[900px] sm:h-[900px] w-[600px] h-[600px] rounded-full top-[50%] left-[50%] translate-x-[-50%] sm:translate-y-[-65%] translate-y-[-90%] flex justify-center items-center">
